...
model = xija.XijaModel(u'example3', start='2014:205:12:10:16.816', stop='2015:240:11:43:44.816', dt=328.0)
...
# Set solarheat__aacccdpt component parameters
comp = model.get_comp(u'solarheat__aacccdpt')
...
comp = model.get_comp(u'heatsink__aacccdpt')
